...
$servername = 'localhost'; //for XAMPP we use localhost
    ...
    $dbname = 'Project 3'; //Change this to whatever database name you set in PHPmyAdmin
...
echo "Record saved";  
$query = "INSERT INTO fooditems (item, amount, unit, calories, protein, carbohydrates, fat) VALUES('$insert_item', '$insert_amount', '$insert_unit', '$insert_calories', '$insert_protein','$insert_carbohydrates','$insert_fat')";
$result = mysqli_query($link, $query);
if($result) {
    echo "Record imported successfully.";
} else {
    echo "Error import record: " . mysqli_error($link);
}
/// (Q10 Ends)
...
<html>
    ...
    <button type="submit" name="deletebtn" id="deletebtn">Delete Button</button>
